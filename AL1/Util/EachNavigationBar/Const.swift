...
struct AssociatedKeys {
    ...
    static var configuration = "com.cashlee.configuration"
    
    static var navigationBar = "com.cashlee.navigationBar"
    
    static var navigationItem = "com.cashlee.navigationItem"
    
    static var observation = "com.cashlee.observation"
}
